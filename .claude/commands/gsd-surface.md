...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/ok/.claude/.gsd-surface.json`
(sibling to `/home/user/ok/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/ok/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/ok/.claude/skills`).
...
`/home/user/ok/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/ok/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/ok/.claude/.gsd-surface.json`
Install profile marker: `/home/user/ok/.claude/.gsd-profile`
Skill dirs: `/home/user/ok/.claude/skills/gsd-*/`
Engine module: `/home/user/ok/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/ok/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
