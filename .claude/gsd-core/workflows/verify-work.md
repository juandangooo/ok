...
<template>
@/home/user/ok/.claude/gsd-core/templates/UAT.md
</template>
...
Read and follow `/home/user/ok/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/user/ok/.claude/gsd-core/workflows/diagnose-issues.md
