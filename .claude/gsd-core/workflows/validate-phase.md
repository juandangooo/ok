...
```
Agent(
  prompt="Read /home/user/ok/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/ok/.claude/gsd-core/templates/VALIDATION.md`
