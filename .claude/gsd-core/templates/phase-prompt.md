...
<!-- For checkpoint task examples and patterns, see @/home/user/ok/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/user/ok/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/user/ok/.claude/gsd-core/templates/user-setup.md` for full schema and examples
